    ...
    <div>
      <Modal show={isVisible} onHide={handleClose} fullscreen={true}>
        ...
        <Modal.Body style={{ height: "90vh" }}>
          {(show?.seasons?.length || 0) > 0 || source?._id ? (
            <>
              {selectedEpisode && selectedEpisode._id && (
                <div>
                  <video
                    ...
                    poster={
                      selectedEpisode.sources.find((s) => s.main)?.poster_key
                    }
                    controls
                  ></video>
                  <input
                  ...
                  <div className={styles.containerShares}>
                    ...
                    <div>
                      {(selectedEpisode.sources.find((s) => s.main)
                        ?.views_count || 0) + 1}{" "}
                      visualizações
                    </div>
                  </div>
                      ...
                      <div className={styles.episodesContainer}>
                        ...
                        <div className={styles.listArea}>
                          <div
                            ...
                            style={{
                              width: `${
                                230 * sectionSelected.episodes.length
                              }px`,
            ...
            <p>Esse programa ainda não tem conteúdo</p>
          )}
        </Modal.Body>
      </Modal>
    </div>
